document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderProjects(projects) {
        ...
        container.innerHTML = projects.map(proj => {
            ...
            return `
                <div class="project-card box-glow">
    ...
    function initCursorAndEffects() {
        ...
        // Bind hover effects to dynamically generated interactive elements
        const interactiveElements = document.querySelectorAll('a, button, .project-card, .skill-category, .btn-primary, .btn-secondary, .hamburger');
